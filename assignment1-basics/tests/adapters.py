...
def run_rope(
    ...
    """
    from cs336_basics.module import RoPEEmbedding
    rope = RoPEEmbedding(theta=theta, d_k=d_k, max_seq_len=max_seq_len)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.loss import gradient_clipping
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.optim import learning_rate_schedule
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    with open(input_path, "rb") as f:
        tokenizer = Tokenizer.train_bpe(f, vocab_size, special_tokens, **kwargs)
